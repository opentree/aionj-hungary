...
public class _2002WheresRae extends QuestHandler {
	...
	private final static int[] npc_ids = { 203519, 203534, 203553, 700045,
			203516, 205020, 203537 };
				...
				case 33:
					if (var == 11) {
						if (QuestService.collectItemCheck(env, true)) {
							...
							return sendQuestDialog(player, env
									.getVisibleObject().getObjectId(), 2376);
					}
				}
			}
				break;
				...
				case 25:
					...
					ThreadPoolManager.getInstance().schedule(new Runnable() {
						...
						public void run() {
							qs.setQuestVar(13);
							updateQuestStatus(player, qs);
							TeleportService.teleportTo(player, 220010000, 1,
									940.15f, 2295.64f, 265.7f, (byte) 43);
						}
					}, 38000);
					return true;
				default:
			...
			case 203537:
				if (var == 14 && env.getDialogId() == -1) {
					...
					QuestService.addNewSpawn(player.getWorldId(),
							player.getInstanceId(), 203553, npc.getX(),
