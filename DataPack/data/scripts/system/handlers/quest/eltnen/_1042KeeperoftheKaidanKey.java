...
public class _1042KeeperoftheKaidanKey extends QuestHandler {
	...
	public void register() {
		...
		qe.setQuestItemIds(182201018).add(questId); // //////////// fix of q
													// item id
													// ///////////////////
	...
	@Override
	public boolean onItemUseEvent(QuestEnv env, Item item) // quest can be
															// completed by
															// using the needed
															// key if it was
															// gained before
															// this fix
	{
		...
		if (id != 182201018) // // for quest state change didn't activate
	...
	@Override
	public boolean onKillEvent(QuestEnv env) // implements(at least partly)
												// finding who has the key from
												// monsters /////////////////
	{
