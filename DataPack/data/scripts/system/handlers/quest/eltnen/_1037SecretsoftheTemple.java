...
public class _1037SecretsoftheTemple extends QuestHandler {
	...
	private final static int[] npc_ids = { 203965, 203967, 700151, 700154,
			700150, 700153, 700152 };
			...
			case 10002:
				if (var == 2) {
					...
					ItemService.addItems(player, Collections
							.singletonList(new QuestItems(182201027, 1)));
					return true;
				}
				return false;
			}
		} else if (targetId == 700151 && var == 3 || targetId == 700154
				&& var == 4 || targetId == 700150 && var == 5
				|| targetId == 700153 && var == 6 || targetId == 700152
				&& var == 7) {
