...
public class _1016SourceOfThePollution extends QuestHandler {
	...
	private final static int[] npc_ids = { 203149, 203148, 203832, 203705,
			203822, 203761, 203098, 203195 };
				...
				case 25:
					if (var == 0)
						...
						if (player.getInventory().getItemCountByItemId(
							...
							return sendQuestDialog(player, env
									.getVisibleObject().getObjectId(), 3569);
					}
				case 3400:
				...
				case 10007:
					if (var == 7) {
						...
						if (!ItemService.addItems(player, Collections
								.singletonList(new QuestItems(182200015, 2))))
			...
			case 203148:
				...
				case 10001:
					if (var == 1) {
						...
						updateQuestStatus(player, qs);
						if (!ItemService.addItems(player, Collections
								.singletonList(new QuestItems(182200017, 1))))
			...
			case 203832:
				...
				case 10003:
					if (var == 3) {
						...
						updateQuestStatus(player, qs);
						if (!ItemService.addItems(player, Collections
								.singletonList(new QuestItems(182200013, 1))))
				...
				case 10005:
					if (var == 5) {
						...
						ItemService.decreaseItemCountByItemId(player,
								182200017, 1);
						if (!ItemService.addItems(player, Collections
								.singletonList(new QuestItems(182200018, 1))))
				...
				case 10006:
					if (var == 6) {
						...
						ItemService.decreaseItemCountByItemId(player,
								182200018, 1);
						if (!ItemService.addItems(player, Collections
								.singletonList(new QuestItems(182200014, 1))))
							;// add Yustiel's Tear
						PacketSendUtility.sendPacket(player,
								new SM_DIALOG_WINDOW(env.getVisibleObject()
										.getObjectId(), 10));
				...
				case 10008:
					if (var == 9) {
						...
						ItemService.decreaseItemCountByItemId(player,
								182200015, 1);
						if (!ItemService.addItems(player, Collections
								.singletonList(new QuestItems(182200016, 1))))
		...
		case 210318:
			if (var == 8) {
				...
				ThreadPoolManager.getInstance().schedule(new Runnable() {
					@Override
					public void run() {
						QuestService.addNewSpawn(210030000, instanceId, 203195,
