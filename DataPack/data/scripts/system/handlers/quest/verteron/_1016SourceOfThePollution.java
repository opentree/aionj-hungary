...
public class _1016SourceOfThePollution extends QuestHandler
{
	...
	private final static int[]	npc_ids	=
										{ 203149, 203148, 203832, 203705, 203822, 203761, 203098, 203195 };
			...
			case 210318:
				if (var == 8)
				{
					...
					ThreadPoolManager.getInstance().schedule(new Runnable()
					{
						...
						public void run()
						{
							QuestService.addNewSpawn(210030000, instanceId, 203195, (float) npc.getX(), (float) npc.getY(), (float) npc.getZ(), (byte) 0, true);
						}
					}, 5000);
