...
public class _2008Ascension extends QuestHandler
{
	...
	public boolean onDieEvent(QuestEnv env)
	{
		...
		if (var == 5 || (var >= 51 && var <= 53))
		{
			qs.setQuestVar(4);
			updateQuestStatus(player, qs);
			PacketSendUtility.sendPacket(player, new SM_SYSTEM_MESSAGE(SystemMessageId.QUEST_FAILED_$1, DataManager.QUEST_DATA.getQuestById(env.getQuestId())
					.getName()));
		}
		return false;
	}
