			...
			if (targetId == 790001) {
				...
				case 10000:
					if (var == 0) {
						...
						PacketSendUtility
								.sendPacket(player, new SM_TELEPORT_LOC(
										110010000, 1313, 1512, 568));
						TeleportService.scheduleTeleportTask(player, 110010000,
								1313, 1512, 568);
						return true;
					}
				}
				...
				case 10002:
					if (var == 2) {
						PlayerClass playerClass = PlayerClass
								.getStartingClassFor(player.getCommonData()
										.getPlayerClass());
