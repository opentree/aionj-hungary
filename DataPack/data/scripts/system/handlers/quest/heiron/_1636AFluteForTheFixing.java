...
public class _1636AFluteForTheFixing extends QuestHandler
{
				...
				case 203792:
				{
					switch (env.getDialogId())
					{
						case 25:
						{
							...
							else if (qs.getQuestVarById(0) == 1 && itemCount1 >= 1 && itemCount2 >= 1 && itemCount3 >= 1 && itemCount4 >= 1)
							{
	...
	public boolean onItemUseEvent(QuestEnv env, final Item item)
	{
		...
		if (MathUtil.getDistance(182, 2703, 143, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ()) > 10)
		{
			return false;
		}
