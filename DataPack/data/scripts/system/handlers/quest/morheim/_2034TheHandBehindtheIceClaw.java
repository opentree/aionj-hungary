...
public class _2034TheHandBehindtheIceClaw extends QuestHandler {
	...
	public boolean onDialogEvent(QuestEnv env) {
			...
			case 10001:
				...
				ItemService
						.addItems(player, Collections
								.singletonList(new QuestItems(182204008, 1)));
		...
		} else if (targetId == 700246
				&& player.getInventory().getItemCountByItemId(182204019) >= 1) {
			if (env.getDialogId() == -1 && var == 2) {
				...
				ThreadPoolManager.getInstance().schedule(new Runnable() {
					...
					public void run() {
						...
						QuestService.addNewSpawn(220020000, 1, 204417,
								(float) 461.23, (float) 188.82, (float) 485.61,
								(byte) 25, true);
