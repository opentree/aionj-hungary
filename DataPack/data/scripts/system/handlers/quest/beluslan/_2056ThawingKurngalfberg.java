	...
	public boolean onDialogEvent(QuestEnv env) {
		...
		if (targetId == 204753) {
			...
			case 2035:
				if (var == 1
						&& player.getInventory()
								.getItemCountByItemId(182204315) != 1) {
					ItemService.addItems(player, Collections
							.singletonList(new QuestItems(182204315, 1)));
					return sendQuestDialog(player, env.getVisibleObject()
							.getObjectId(), 2035);
				} else
					return sendQuestDialog(player, env.getVisibleObject()
			...
			case 1353:
				if (var == 1
						&& player.getInventory()
								.getItemCountByItemId(182204313) != 1) {
					ItemService.addItems(player, Collections
							.singletonList(new QuestItems(182204313, 1)));
					return sendQuestDialog(player, env.getVisibleObject()
							.getObjectId(), 1353);
				} else
					return sendQuestDialog(player, env.getVisibleObject()
			...
			case 1694:
				if (var == 1
						&& player.getInventory()
								.getItemCountByItemId(182204314) != 1) {
					ItemService.addItems(player, Collections
							.singletonList(new QuestItems(182204314, 1)));
					return sendQuestDialog(player, env.getVisibleObject()
							.getObjectId(), 1694);
				} else
					return sendQuestDialog(player, env.getVisibleObject()
