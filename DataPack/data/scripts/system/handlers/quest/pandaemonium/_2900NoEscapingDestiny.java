...
public class _2900NoEscapingDestiny extends QuestHandler {
				...
				case 10004:
					if (var == 4) {
						...
						WorldMapInstance newInstance = InstanceService
								.getNextAvailableInstance(320070000);
						InstanceService.registerPlayerWithInstance(newInstance,
								player);
						TeleportService.teleportTo(player, 320070000,
								newInstance.getInstanceId(), 257.5f, 245f,
								129f, 0);
						return true;
					}
					break;
				...
				case 10007:
					if (var == 97) {
						...
						PacketSendUtility.sendPacket(player,
								new SM_DIALOG_WINDOW(env.getVisibleObject()
										.getObjectId(), 0));
						QuestService.addNewSpawn(320070000, instanceId, 204263,
								257.5f, 245f, 129f, (byte) 0, true);
						return true;
					}
					break;
				case 3058:
	...
	public boolean onKillEvent(QuestEnv env) {
		...
		if (targetId == 204263 && qs.getQuestVars().getQuestVars() == 98) {
			qs.setQuestVar(9);
			updateQuestStatus(player, qs);
			TeleportService.teleportTo(player, 220010000, 1, 1111.6f, 1716.6f,
					270.6f, 0);
			return true;
		}
		return false;
	...
	public boolean onMovieEndEvent(QuestEnv env, int movieId) {
		...
		QuestState qs = player.getQuestStateList().getQuestState(questId);
		if (qs == null || qs.getStatus() != QuestStatus.START
				|| qs.getQuestVars().getQuestVars() != 95)
			return false;
		qs.setQuestVar(99);
		updateQuestStatus(player, qs);
		return true;
