...
public class _4937RecognitionOfThePreceptors extends QuestHandler
{
	...
	public boolean onDialogEvent(QuestEnv env)
	{
		...
		if (qs.getStatus() == QuestStatus.START)
		{
			...
			switch (targetId)
			{
				// 1 - Get Freyr's signature on the Fenris's Fangs recommendation
				// letter
				case 204059:
					...
					break;
				// 2 - Get Sif's signature on the Fenris's Fangs recommendation
				// letter.
				case 204058:
					if (var == 1)
					{
					...
					break;
				// 3 - Get Sigyn's signature on the Fenris's Fangs recommendation
				// letter.
				case 204057:
					if (var == 2)
					{
					...
					break;
				// 4 - Get Traufnir's signature on the Fenris's Fangs recommendation
				// letter.
				case 204056:
					if (var == 3)
					{
