...
public class Appearance extends AdminCommand
{
	...
	public void executeCommand(Player admin, String[] params)
	{
		...
		if (params[0].equals("reset"))
		{
			...
			// Send update packets
			TeleportService
					.teleportTo(player, player.getWorldId(), player.getInstanceId(), player.getX(), player.getY(), player.getZ(), player.getHeading(), 0);
	...
	{
		AdminCommandChatHandler.getInstance().registerAdminCommand(new Appearance());
	}
}
