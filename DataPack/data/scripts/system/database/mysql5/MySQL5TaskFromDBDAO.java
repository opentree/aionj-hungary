...
public class MySQL5TaskFromDBDAO extends TaskFromDBDAO {
	...
	private static final Logger log = Logger
			.getLogger(MySQL5TaskFromDBDAO.class);
	...
	public ArrayList<TaskFromDB> getAllTasks() {
		...
		try {
			...
			while (rset.next())
				result.add(new TaskFromDB(rset.getInt("id"), rset
						.getString("task"), rset.getString("type"), rset
						.getTimestamp("last_activation"), rset
						.getString("startTime"), rset.getInt("delay"), rset
						.getString("param")));
