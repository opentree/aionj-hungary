...
public class MySQL5PlayerQuestListDAO extends PlayerQuestListDAO {
	private static final Logger log = Logger
			.getLogger(MySQL5PlayerQuestListDAO.class);
	 ...
	 * 
	 * @see
	 * com.aionemu.gameserver.dao.PlayerQuestListDAO#load(com.aionemu.gameserver
	...
	public QuestStateList load(final Player player) {
		...
		try {
			...
			while (rset.next()) {
				...
				QuestStatus status = QuestStatus.valueOf(rset
						.getString("status"));
				QuestState questState = new QuestState(questId, status,
						questVars, completeCount);
	 ...
	 * 
	 * @see
	 * com.aionemu.gameserver.dao.PlayerQuestListDAO#store(com.aionemu.gameserver
	 * .model.gameobjects.player.Player)
	 */
	@Override
	...
	/**
	 * @param playerId
	 *            The playerObjectId of the player who's quest needs to be
	 *            deleted
	 * @param questId
	 *            The questId that needs to be deleted
	 */
