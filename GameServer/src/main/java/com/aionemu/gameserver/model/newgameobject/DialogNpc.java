...
import com.aionemu.gameserver.model.newgameobject.interfaces.IDialogSelect;
 ...
 *
 */
public class DialogNpc extends Npc implements IDialogRequest, IDialogSelect, IReward
{
	 ...
	 */
	@Override
	public void doReward(com.aionemu.gameserver.model.newgameobject.Player.Player player)
	{
	}
