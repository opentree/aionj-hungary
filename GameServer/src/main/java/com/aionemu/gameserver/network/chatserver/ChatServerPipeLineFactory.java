 ...
 *
 */
public class ChatServerPipeLineFactory extends AbstractPipeLineFactory
{
	@Override
	public ChannelPipeline getPipeline() throws Exception
	{
		...
		pipeline.addLast("handler", new ChatServerChannelHandler(new ChatServerPacketHandlerFactory()));
