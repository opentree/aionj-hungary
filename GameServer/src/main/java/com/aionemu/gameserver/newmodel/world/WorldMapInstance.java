...
public class WorldMapInstance
{
	 ...
	 */
	private final Map<Integer, SpawnedObject>	worldMapObjects		= new FastMap<Integer, SpawnedObject>().shared();
	 ...
	 * @return a MapRegion
	 */
	MapRegion getRegion(SpawnedObject object)
	{
		return getRegion(object.getPosition().getX(), object.getPosition().getY(), object.getPosition().getZ());
	}
	...
	public Collection<SpawnedObject> getAllWorldMapObjects()
	{
