...
public class CryptEngine
{
	 ...
	 * A key
	 */
	private byte[]			key			= { (byte) 0x6b, (byte) 0x60, (byte) 0xcb, (byte) 0x5b, (byte) 0x82,
	...
	/**
	 * Default constructor. Initialize the Blowfish Cipher with an initial static key to encrypt the first packet sent
	 * to the client
	 */
	public CryptEngine()
	{
