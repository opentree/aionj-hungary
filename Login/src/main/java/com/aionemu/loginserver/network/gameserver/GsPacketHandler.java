 ...
 * @author MrPoke
 */
public class GsPacketHandler extends PacketHandler<GsConnection>
{
	 ...
	 */
	@Override
	public GsClientPacket handle(ChannelBuffer data, GsConnection client)
	{
		return (GsClientPacket)super.handle(data, client);
	}
